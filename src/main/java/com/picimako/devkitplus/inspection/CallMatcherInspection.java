...
import static com.picimako.devkitplus.CallMatcherUtil.CALL_MATCHER_INSTANCE_MATCHER;
...
import static com.picimako.devkitplus.reference.CallMatcherReferenceContributor.findClass;
                    ...
                    Optional.ofNullable(findClass(referencedClassFqn))
                        .ifPresent(referencedClass -> {
                            ...
                            if (!methodCountAndMessage.equals(Pair.empty()) && methodCountAndMessage.first == 0) {
                                holder.registerProblem(literalExpr, DevKitPlusBundle.inspection(methodCountAndMessage.second), ProblemHighlightType.LIKE_UNKNOWN_SYMBOL);
                            }
                        });
                }
            }
