    ...
    private static final class LightServiceHandler implements LanguageCodeInsightActionHandler {
        ...
        private PsiMethod createGetInstance(PsiClass staticOrTopLevelClass, Project project) {
            ...
            switch (serviceLevel) {
                ...
                case NOT_SURE:
                default:
                    Messages.showWarningDialog(DevKitPlusBundle.message("devkit.action.light.service.generate.static.getter.warning.message"), DevKitPlusBundle.message("devkit.action.light.service.generate.static.getter.warning.title"));
            }
            return null;
        }
