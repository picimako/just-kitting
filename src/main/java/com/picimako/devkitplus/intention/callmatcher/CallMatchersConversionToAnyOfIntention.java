...
public class CallMatchersConversionToAnyOfIntention implements IntentionAction {
    ...
    public @IntentionName @NotNull String getText() {
        return DevKitPlusBundle.message("intention.call.matcher.combine.to.any.of.name");
    }

    @Override
    public @NotNull @IntentionFamilyName String getFamilyName() {
        return DevKitPlusBundle.message("intention.call.matcher.family.name");
    }
    ...
    private void introduceCombinedCallMatcherInSelectedClass(List<PsiClass> parentClasses, Consumer<PsiClass> introduceField, Editor editor, Project project) {
        var step = new BaseListPopupStep<>(DevKitPlusBundle.message("intention.call.matcher.combine.to.any.of.select.class"), parentClasses) {
            @Override
