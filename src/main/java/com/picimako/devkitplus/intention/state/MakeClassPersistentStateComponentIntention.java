...
import com.picimako.devkitplus.ListPopupHelper;
import com.picimako.devkitplus.intention.state.ConversionActions.WithSelfAsState;
import com.picimako.devkitplus.intention.state.ConversionActions.WithStandaloneStateObject;
...
public class MakeClassPersistentStateComponentIntention extends BaseIntentionAction {
    ...
    public @IntentionName @NotNull String getText() {
        return DevKitPlusBundle.message("devkit.intention.convert.to.persistent.state.component.text");
    }

    @Override
    public @NotNull @IntentionFamilyName String getFamilyName() {
        return DevKitPlusBundle.message("devkit.intention.convert.to.persistent.state.component.family");
    }
