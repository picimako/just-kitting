...
import static com.picimako.justkitting.ListPopupHelper.showActionsInListPopup;
import static com.picimako.justkitting.PlatformNames.INSPECTION_PROFILE_ENTRY;
...
public class CreateInspectionOptionsPanelAction extends BaseCodeInsightAction {
    ...
    private static final class GenerationOptionsPanelHandler implements LanguageCodeInsightActionHandler {
        ...
        public void invoke(@NotNull Project project, @NotNull Editor editor, @NotNull PsiFile file) {
            showActionsInListPopup(JustKittingBundle.message("intention.ui.select.panel.type.title"), ACTIONS, editor);
        }
