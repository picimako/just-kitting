...
import com.picimako.devkitplus.inlayhint.Settings.Companion.MAX_NO_OF_SERVICES
...
class LightServicesInlayHintsProvider : InlayHintsProvider<Settings> {
    ...
    override val name: String
        get() = DevKitPlusBundle.inlayHints("light.services.settings.type.title")
    ...
    override fun createConfigurable(settings: Settings): ImmediateConfigurable {
        return object : ImmediateConfigurable {
            ...
            override val mainCheckboxText: String
                get() = DevKitPlusBundle.inlayHints("light.services.settings.show.hints.option")

            override fun createComponent(listener: ChangeListener): JComponent {
                val panel = panel {
                    row {
                        label(DevKitPlusBundle.inlayHints("light.services.display.mode.label"))
                    ...
                    row {
                        label(DevKitPlusBundle.inlayHints("light.services.settings.max.no.of.services.label"))
                            ...
                            maxNoOfServicesTextField.let {
                                ...
                                if (maxServices.isNotBlank()) {
                                    try {
                                        ...
                                        ValidationInfo(
                                            DevKitPlusBundle.inlayHints("light.services.settings.value.must.be.a.number"),
                                            maxNoOfServicesTextField
                                        )
                                    }
                                } else {
