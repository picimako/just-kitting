...
enum class InlayDisplayMode(val displayName: String) {
     ...
     */
    Disabled(DevKitPlusBundle.inlayHints("light.services.settings.display.mode.disabled")),
     ...
     */
    ListOfLightServices(DevKitPlusBundle.inlayHints("light.services.settings.display.mode.list.of.services")),

    /**
     * Displays only a View All... hint.
     */
    ViewAllOnly(DevKitPlusBundle.inlayHints("light.services.settings.display.mode.view.all.only"))
}
